...
- Hors périmètre (non masqué) : Vue Élève (n'affiche que des prénoms), modales centrées sur UN élève ouvertes explicitement (fiche, historique), stats d'appel par élève (`mattStats`), projection d'un bilan, exports et impressions.
