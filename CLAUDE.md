...
- **Décomposition « tes données » vs « en mémoire locale »** (`_lsKeyBreakdown`) : voir 1,1 Mo en haut et 2,1 Mo en bas est incompréhensible sans elle — signalé en usage réel. Quand l'écart dépasse 50 Ko, la jauge nomme les clés responsables.
