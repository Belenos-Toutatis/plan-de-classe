...
- **Onglet Élèves** : toute la cellule du nom révèle l'élève (`<td onclick="_confNameClick(…)">`), pas seulement le texte du nom ; `onEleveRowMouseDown` n'y démarre pas de sélection pour un élève masqué.
...
- Hors périmètre (non masqué) : Vue Élève (n'affiche que des prénoms), modales ouvertes explicitement par l'enseignant (Vue d'ensemble, fiche, historique, projection d'un bilan…), exports et impressions.
